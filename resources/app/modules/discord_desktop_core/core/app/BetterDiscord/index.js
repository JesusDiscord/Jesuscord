...
electron.ipcRenderer.sendSync("LIGHTCORD_SET_USER_AGENT", UserAgent), exports.init = function ({
    ...
    if (1 == hasInit) return void console.warn(new Error("Justicecord has already started."));
    ...
    /*let t = setInterval(() => {
        ...
        try {
            ...
            clearInterval(t), privateInit().then(() => {
                console.log("Finished loading Justicecord.")
            })
        } catch (e) {
            console.error(e)
        }
    ...
    (async function () {
        ...
        if (f) {
            ...
            f.setConsents = function () {
                return m ? Promise.reject(new Error("Justicecord bot emulation cannot change this setting.")) : t.call(this, ...arguments)
            }
        } else logger.warn(new Error("Couldn't find module here"));
        ...
        if (v) {
            ...
            v.fetchPremiumSubscriptionCooldown = function () {
                return m ? new Promise((e, t) => {
                    t(new Error("Justicecord bot emulation cannot use Server Boosts"))
        ...
        if (R) {
            ...
            R.default.joinHypeSquadOnline = function () {
                return m ? Promise.reject(new Error("Justicecord bot emulation cannot join hypesquad.")) : e.call(this, ...arguments)
            }
        } else logger.warn(new Error("Couldn't find module here"));
        ...
        if (M) {
            ...
            M.default.loadTemplatesForGuild = function () {
                return m ? Promise.reject(new Error("Justicecord bot emulation cannot use Guild Templates")) : e.call(this, ...arguments)
            }
        } else logger.warn(new Error("Couldn't find module here"));
        ...
        if (O) {
            ...
            O.default.prototype.fetch = function (t, r, n) {
                if (!m) return e.call(this, ...arguments);
                n(new Error("Justicecord bot emulation cannot search in guild."))
            }
        } else logger.warn(new Error("Couldn't find module here"));
        ...
        if (H) {
            ...
            H.default.acceptInvite = function (t, r, n) {
                return m ? (s.dispatch({
                    ...
                    code: t
                }), h.showToast("Justicecord Bot Emulation cannot join guilds.", {
                    type: "error"
                }), Promise.reject("Justicecord Bot Emulation cannot join guilds.")) : e.call(this, ...arguments)
            }
        } else logger.warn(new Error("Couldn't find module here"))
